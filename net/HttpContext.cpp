...
HttpContext::LINE_STATE HttpContext::parse_line(char* rd_buf, size_t rb_ptr){
...
HttpContext::HTTP_CODE HttpContext::parse_request(char* text)
{
...
HttpContext::HTTP_CODE HttpContext::parse_header(char* text)
{
    //空请求头，表示header结束
    if(text[0]=='\0'){
